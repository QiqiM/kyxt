	...
	<body>
		...
		<div class="login">
			...
			<form class="layui-form">
				...
				<div class="layui-form-item">
					<input class="layui-input" id="pwd1" name="pwd1" placeholder="新密码(请输入6-8位的数字字母组合)" lay-verify="required|pwd" type="password" autocomplete="off">
				</div>
				<div class="layui-form-item">
					<input class="layui-input" id="pwd2" name="pwd2" placeholder="确认密码(请输入6-8位的数字字母组合)" lay-verify="required|pwd" type="password" autocomplete="off">
				</div>
